...
object Day8 {
    ...
    private class SequenceOfAction(val lines:List<String>){
        ...
        fun findAccBeforeLoop() : Int {
            ...
            do {
                ...
                var (a,i) = linesVisited[idx].first.apply(accumulated,idx)
        ...
        fun simulate(actionsVisited : MutableList<Pair<Action,Boolean>>) : Pair<Boolean, Int> {
            ...
            do {
                //apply current line action
                var (a,i) = actionsVisited[idx].first.apply(accumulated,idx)
    ...
    fun getResult() : Int {
        return SequenceOfAction(input.split("\n")).findAccBeforeLoop()

    }

    fun getResultAdvanced() : Int {
        return return SequenceOfAction(input.split("\n")).findTerminateResult()
    }
