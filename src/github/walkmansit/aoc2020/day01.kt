...
object Day1 {
    ...
    fun getResult() : Int {
        ...
        val seen = inputList.map { 2020 - it }.toSet()
    ...
    fun getResultAdvanced() : Int {
        ...
        for (i in inputList.indices-1)
            for (j in 1 until Day1.inputList.size)
                diffSet[2020 - inputList[i] - inputList[j]] = inputList[i] * inputList[j]
