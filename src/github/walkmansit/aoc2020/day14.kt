...
object Day14 {
    ...
    private class MaskMachine(val commands:Array<String>){
    ...
    fun getResult() : Long {
        return MaskMachine(input.lines().toTypedArray()).applyCommandsAndGetSum()
    }

    fun getResultAdvanced() : Long {
        return MaskMachine(input.lines().toTypedArray()).applyCommandsWithMemory()
    }
