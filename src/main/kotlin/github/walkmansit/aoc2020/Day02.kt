...
class Day02(val input: List<String>) : DayAoc<Int, Int> {
    ...
    private class PasswordWithPolicy private constructor(
        val start: Int,
        val end: Int,
        val target: Char,
        val password: String
        ...
        fun isValidPolicy2() =
            (password[start - 1] == target && password[end - 1] != target) || (password[start - 1] != target && password[end - 1] == target)
